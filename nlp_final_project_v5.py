...
print ('The Accuracy is: ' + str(accuracy_base))
...
precision_base, recall_base, accuracy_base = evaluate_predictions(y_train, y_train_base, 0.5,None)
print ('The Precision for each class is: ' + str(precision_base))
print ('The Recall for each class is: ' + str(recall_base))
...
print ('The Accuracy Overall is: ' + str(accuracy))
